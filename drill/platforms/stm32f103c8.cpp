...
//   // TODO(#125): Initializing the can peripheral without it connected to a
//   can
...
{
  using namespace hal::literals;
  hal::set_terminate(sjsu::drill::resources::terminate_handler);
